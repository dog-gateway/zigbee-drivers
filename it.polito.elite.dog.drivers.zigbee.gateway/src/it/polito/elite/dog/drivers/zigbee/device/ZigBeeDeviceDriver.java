 ...
 *
 */
public abstract class ZigBeeDeviceDriver extends ZigBeeDriver implements Driver, ManagedService
{
	...
	// the bundle context
		...
		private HashSet<ZigBeeDriverInstance> managedInstances;
		...
		public void activate(BundleContext context)
		{
			...
			this.managedInstances = new HashSet<ZigBeeDriverInstance>();
		...
		public void deactivate()
		{
			...
			for (ZigBeeDriverInstance instance : this.managedInstances)
				...
				throws Exception
		{
			if (this.regDriver != null)
			{
				...
				ZigBeeDriverInstance driverInstance = this.createNewZigBeeDriverInstance(
