 ...
 * 
 */
public class ZigBeeEnergyAndPowerMeterDriverInstance extends ZigBeeDriver implements EnergyAndPowerMeter
{
	 ...
	 *            instance.
	 */
	public ZigBeeEnergyAndPowerMeterDriverInstance(ZigBeeNetwork network, ControllableDevice device,
	...
	public void notifyStateChanged(State newState)
	{
		...
		this.logger.log(LogService.LOG_DEBUG,
				ZigBeeEnergyAndPowerMeterDriver.logId + "Device " + this.device.getDeviceId() + " is now "
	...
	public void notifyNewActivePowerValue(Measure<?, ?> powerValue)
	{
		...
		((EnergyAndPowerMeter) this.device).notifyNewActivePowerValue(powerValue);
		
		// debug
		this.logger.log(LogService.LOG_DEBUG, ZigBeeEnergyAndPowerMeterDriver.logId + "Notifying power value: "
				+ powerValue);
	...
	public void notifyNewActiveEnergyValue(Measure<?, ?> value)
	{
		...
		// debug
		this.logger.log(LogService.LOG_DEBUG, ZigBeeEnergyAndPowerMeterDriver.logId + "Notifying active energy value: "
				+ value);
	...
	public void setIAppliance(ZigBeeApplianceInfo appliance)
	{
		...
		// debug
		this.logger.log(LogService.LOG_DEBUG, ZigBeeEnergyAndPowerMeterDriver.logId + "Subscribed to all clusters");
	}
		...
		if (cluster != null)
		{
			...
			try
			{
				...
				acceptedParams = cluster
						.setAttributeSubscription(SimpleMeteringServer.ATTR_IstantaneousDemand_NAME,
