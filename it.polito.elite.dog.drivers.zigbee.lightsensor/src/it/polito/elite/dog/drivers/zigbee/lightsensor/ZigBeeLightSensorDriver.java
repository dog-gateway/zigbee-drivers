 ...
 * 
 */
public class ZigBeeLightSensorDriver extends ZigBeeDriver
		implements Driver, ManagedService
{
	...
	private HashSet<ZigBeeLightSensorDriverInstance> managedInstances;
	...
	public void activate(BundleContext context)
	{
		...
		this.managedInstances = new HashSet<ZigBeeLightSensorDriverInstance>();
		...
		this.driverInfo.setDriverVersion(context.getBundle().getVersion()
				.toString());
		this.driverInfo.setMainDeviceClass(LightSensor.class
				.getSimpleName());
		this.driverInfo.addServerClusters(IlluminanceMeasurementServer.class.getName()
				.replaceAll("Server", ""));
	...
	public void deactivate()
	{
		...
		for (ZigBeeLightSensorDriverInstance instance : this.managedInstances)
		...
		if (this.regDriver != null)
		{
			...
			if (deviceCategory != null)
			{
				if (manifacturer != null
						...
						&& (deviceCategory.equals(LightSensor.class
								.getName())))
				{
					matchValue = LightSensor.MATCH_MANUFACTURER
							+ LightSensor.MATCH_TYPE;
				}
			...
			throws Exception
	{
		if (this.regDriver != null)
		{
			...
			ZigBeeLightSensorDriverInstance driverInstance = new ZigBeeLightSensorDriverInstance(
			...
			throws ConfigurationException
	{
		if (configParams != null)
		{
			...
			this.registerLightSensorDriver();
		}
	}
	 ...
	 */
	private void registerLightSensorDriver()
	{
